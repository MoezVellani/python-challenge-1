...
menu_selection = input("Please enter you selection from the menu: ")
# 3. Check if the customer typed a number
if menu_selection.isdigit():
    # Convert the menu selection to an integer
    menu_selection = int(menu_selection)
# 4. Check if the menu selection is in the menu items
if 1 <= menu_selection <= len(menu_items_dict):
    # Store the item name as a variable
    item_name = menu_items_dict[menu_selection]["Item name"]
    item_price = menu_items_dict[menu_selection]["price"]
    ...
    while True:
        ...
        match keep_ordering:
            ...
            case "n":
                ...
                break
            case _:
                print('Invaid input. Please enter "Y" or "N".')
